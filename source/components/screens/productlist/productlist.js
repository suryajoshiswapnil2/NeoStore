...
import {View, Text,StatusBar,FlatList,Image,ActivityIndicator} from 'react-native'
        ...
        return(
            ...
            <CustomHeader leftIcon='chevron-left' style={{fontSize: 20,}} leftAction={()=>{this.props.navigation.navigate('Home')}} title={this.props.navigation.state.params.title} rightIcon='search'/>      
                 ...
                 <View style={styles.bottomViewer}>  
                    <Text style={styles.bottomViewerText}>SHOWING {this.state.offset} OF {this.state.limit}</Text>
                 </View>
            </View>
